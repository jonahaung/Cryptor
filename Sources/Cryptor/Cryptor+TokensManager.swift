...
typealias PublicKeysHotStorage = Cryptor.PublicKeysHotStorage
public extension Cryptor {
    ...
    struct PublicKeysHotStorage {
        ...
        public static func store(publicKey base64String: String, for userID: String) {
            guard let publicKey = Cryptor.publicKey(with: base64String) else { return } // Not a valid public key
        ...
        public static func get(for userID: String) -> Curve25519.KeyAgreement.PublicKey? {
            guard let pk64String = HotStorage.get(key: userID),
                  let pk = Cryptor.publicKey(with: pk64String as String) else  {
                return nil
            }
            return pk
        }
